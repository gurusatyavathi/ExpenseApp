...
import com.example.team3_expenseapp.databinding.FragmentTransactionBinding;
...
public class TransactionFragment extends Fragment {
    ...
    //constructor
    public TransactionFragment(TransactionServices transactionServices, User currentUser) {
    ...
    private ArrayList<Transaction> fetchData() {
        ...
        if (transactionServices != null) {
            list.addAll(transactionServices.getListOfTransactions(dbHelper, currentUser.getId()));
        }
        if (list.isEmpty()) {
    ...
    private void addTransaction(EditText editTextAmount, EditText editTextDate, RadioGroup radioGroup, Spinner spinner, EditText editTextNotes) {
        try {
            ...
            boolean result = transactionServices.addTransaction(transaction, dbHelper, currentUser.getId());
            if (result) {
